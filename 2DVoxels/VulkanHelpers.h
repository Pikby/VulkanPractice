...
class VulkanInstance : public VulkanHelper {
private:
    VkInstance instance;
    ...
    void checkExtensions(std::vector<const char*> requiredExtensions, std::vector<VkExtensionProperties> availableExtensions) {
...
class VulkanLogicalDevice : public VulkanHelper {
private:
    VkInstance& instance;
    VkSurfaceKHR& surface;
    ...
    bool isDeviceSuitable(VkPhysicalDevice device) {
        //This function can be used to find the optimal GPU but rn just take any GPU instead
...
class VulkanSwapChain : VulkanHelper
{
private:
    VkDevice& device;
...
class VulkanCommandPool : public VulkanHelper {
private:
    VkCommandPool commandPool;
    VkDevice& device;
public:
...
class VulkanSyncObjects : public VulkanHelper {
private:
    VkDevice& device;
...
public:
    ...
    VulkanSyncObjects() = delete;
    VulkanSyncObjects(const VulkanSyncObjects&);
    VulkanSyncObjects& operator=(const VulkanSyncObjects&);
